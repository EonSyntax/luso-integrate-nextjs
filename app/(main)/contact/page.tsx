export default function Contact() {
  return (
    <main className="font-manrope px-6 py-12 md:py-20 bg-background-dark w-full">
      <div className=" max-w-7xl mx-auto">
        ...
        <div className="mb-16 pt-20 text-center md:text-left">
          ...
          <p className="text-slate-400 dark:text-slate-400 text-lg max-w-2xl">
            Ready to take your business to the next level? Our global team is
            here to help you integrate, innovate, and scale.
          </p>
        </div>
        {/* Two Column Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          {/* Left Column: Form */}
          <div className="lg:col-span-7 bg-slate-900 dark:bg-slate-900/50 p-8 md:p-10 rounded-xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-800">
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    className="w-full text-white bg-slate-700 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg h-12 px-4 focus:ring-primary focus:border-primary transition-all placeholder:text-slate-400"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  className="w-full bg-slate-700 dark:bg-slate-800 text-white border-slate-200 dark:border-slate-700 rounded-lg p-4 focus:ring-primary focus:border-primary transition-all placeholder:text-slate-400 resize-none"
            ...
            <div className="space-y-8">
              ...
              <div className="group">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl text-white font-extrabold uppercase tracking-wider">
                    Nigeria Office
                  </h3>
                </div>
                <div className="pl-12 space-y-2">
                  ...
                  <a
                    className="flex items-center gap-2 text-white dark:text-slate-100 font-semibold hover:text-primary transition-colors"
              ...
              <div className="group border-t border-slate-200 dark:border-slate-800 pt-8">
                ...
                <div className="pl-12">
                  <a
                    className="text-lg font-bold text-slate-100 dark:text-slate-100 hover:text-primary underline decoration-primary decoration-2 underline-offset-4 transition-all"
